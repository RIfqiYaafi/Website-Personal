    ...
    <div class="main-content">
        <div class="container">
            ...
            <div id="convert-tool" class="tool-section hidden">
                ...
                <form id="convert-form" action="convert_excel_wkt.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                ...
                <script src="scriptwkt.js"></script>
            </div>
            ...
            <div id="convert_csv-tool" class="tool-section hidden">
                ...
                <form id="kml-form" action="backend.php" method="post" enctype="multipart/form-data">
            ...
            <div id="sto-tool" class="tool-section hidden">
                ...
                <form id="sto-form" action="backendsto.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                ...
                <script src="scriptsto.js"></script>
            </div>
